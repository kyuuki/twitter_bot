...
class TwitterAccountsControllerTest < ActionDispatch::IntegrationTest
  ...
  #     post twitter_accounts_url, params: { twitter_account: { access_token: @twitter_account.access_token, access_token_secret: @twitter_account.access_token_secret, account: @twitter_account.account, consumer_key: @twitter_account.consumer_key, consumer_secret: @twitter_account.consumer_secret } }
  #   end
  ...
  #   patch twitter_account_url(@twitter_account), params: { twitter_account: { access_token: @twitter_account.access_token, access_token_secret: @twitter_account.access_token_secret, account: @twitter_account.account, consumer_key: @twitter_account.consumer_key, consumer_secret: @twitter_account.consumer_secret } }
